...
import "../index.css";
import img from "../assests/tms.webp";
                    ...
                    <div className="container">
                        <div className="row g-0">
                            <div className="col-md-6 text-center text-md-start">
                                <p className="mb-md-0">&copy; <a className="text-white border-bottom" href="#">AR</a>. All Rights Reserved.</p>
                            </div>
                            <div className="col-md-6 text-center text-md-end">
                                <p className="mb-0"><a className="text-white border-bottom" >Created by Ayush</a></p>
                            </div>
                        </div>
                    </div>
                </div>
